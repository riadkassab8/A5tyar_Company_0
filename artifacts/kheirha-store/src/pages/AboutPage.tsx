    ...
    <main className="store-shell py-12 space-y-24">
      ...
      <section className="space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <span className="text-xs font-black text-[#0B4A3D] uppercase tracking-wider">قيمنا الجوهرية</span>
          <h2 className="font-display text-3xl sm:text-5xl font-black text-[#0B4A3D]">لماذا تختار "أختيار"؟</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-3xl p-8 border border-[#E5E2D8] shadow-sm hover:shadow-md transition-shadow space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-[#F7F4EA] grid place-items-center text-[#0B4A3D]">
              <Leaf size={28} />
            </div>
            <h3 className="font-display text-xl font-extrabold text-[#0B4A3D]">طبيعي 100% بدون إضافات</h3>
          ...
          <div className="bg-white rounded-3xl p-8 border border-[#E5E2D8] shadow-sm hover:shadow-md transition-shadow space-y-4">
            ...
            <h3 className="font-display text-xl font-extrabold text-[#0B4A3D]">فحص وجودة صارمة</h3>
            <p className="text-xs text-slate-500 font-medium leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-8 border border-[#E5E2D8] shadow-sm hover:shadow-md transition-shadow space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-[#E8F8F5] grid place-items-center text-[#075548]">
              <Award size={28} />
            </div>
            <h3 className="font-display text-xl font-extrabold text-[#0B4A3D]">مصدر موثوق من المزارع</h3>
            <p className="text-xs text-slate-500 font-medium leading-relaxed">
      ...
      <section className="rounded-3xl bg-[#F7F4EA] border border-[#E8E4D9] p-8 sm:p-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="space-y-2">
            <div className="flex justify-center text-[#0B4A3D] mb-2"><Users size={28} /></div>
            <div className="font-display text-3xl sm:text-4xl font-black text-[#0B4A3D]">+10,000</div>
            <div className="text-xs font-bold text-slate-500">عميل يثق بنا</div>
          </div>
          <div className="space-y-2">
            <div className="flex justify-center text-[#0B4A3D] mb-2"><Leaf size={28} /></div>
            <div className="font-display text-3xl sm:text-4xl font-black text-[#0B4A3D]">100%</div>
            <div className="text-xs font-bold text-slate-500">منتجات طبيعية</div>
          </div>
          <div className="space-y-2">
            <div className="flex justify-center text-[#0B4A3D] mb-2"><Star size={28} /></div>
            <div className="font-display text-3xl sm:text-4xl font-black text-[#0B4A3D]">4.9 / 5</div>
            <div className="text-xs font-bold text-slate-500">تقييم الجودة</div>
          </div>
          <div className="space-y-2">
            <div className="flex justify-center text-[#0B4A3D] mb-2"><Award size={28} /></div>
            <div className="font-display text-3xl sm:text-4xl font-black text-[#0B4A3D]">15+</div>
